...
sudo dnf config-manager --add-repo https://download.docker.com/linux/fedora/docker-ce.repo  # https://mirrors.ustc.edu.cn/docker-ce/linux/fedora/docker-ce.repo
